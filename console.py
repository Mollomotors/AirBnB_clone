#!/usr/bin/python3
"""This module defines the call of the command interpreter.

The`HBNBCommand()`, which is a sub-class of the `cmd.Cmd` class.
The module defines alternatives that allows us to manipulate the
storage system (FileStorage / DB). This alteration will allow us to
change the type of storage easily without updating codebase.
